...
class Track:
    ...
    cosine_similarity : float
        The cosine similarity value of the last match with a detection.
    ...
    def __init__(
        ...
        self.cosine_similarity = None  # Store the cosine similarity from matching
    ...
    def get_cosine_similarity(self):
        """
        Get the cosine similarity of the last match.
        Will be None if no match was found in the last update.
        """
    ...
    def predict(self, kf):
        ...
        self.others = None
        self.cosine_similarity = None  # Reset similarity when no match

    def update(self, kf, detection, similarity=None):
        ...
        similarity : Optional[float]
            The cosine similarity value of the match with this detection.
        ...
        # Store the cosine similarity if provided
